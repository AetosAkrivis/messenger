 ...
 */
package com.learning.messenger.services;

import java.util.Collection;
import java.util.HashMap;
import java.util.Map;
import com.learning.messenger.mockDataBase.MockDataBase;
import com.learning.messenger.model.Message;
...
public class MessageService {
    ...
    public Message updateMessage(long id, Message message){
        Message msgToUpdate = messages.get(id);
        msgToUpdate.setContent(message.getContent());
        return msgToUpdate;
    }
